...
legend(1880,.9, col=c("yellow"), lty = 1,lwd=2.0, legend=c("1850-2014"), bty="n", text.font=2, cex=1)
abline(lm(Annual_Anomaly[1:31] ~ year[1:31]),lwd=2.0, col = "blue")
legend(1880,.8, col=c("blue"), lty = 1,lwd=2.0, legend=c("1850-1910"), bty="n", text.font=2, cex=1)
abline(lm(Annual_Anomaly[1:71] ~ year[1:71]), lwd=2.0, col = "green")
legend(1880,.7, col=c("green"), lty = 1,lwd=2.0, legend=c("1850-1950"), bty="n", text.font=2, cex=1)
abline(lm(Annual_Anomaly[1:96] ~ year[1:96]), lwd=2.0, col = "red")
legend(1880,.6, col=c("red"), lty = 1,lwd=2.0, legend=c("1850-1975"), bty="n", text.font=2, cex=1)
abline(lm(Annual_Anomaly[1:121] ~ year[1:121]),lwd=2.0, col = "orange")
legend(1880,.5, col=c("orange"), lty = 1,lwd=2.0, legend=c("1850-2000"), bty="n", text.font=2, cex=1)
